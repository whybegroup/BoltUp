...
import { View, Text, ScrollView, TouchableOpacity, TextInput, StyleSheet, SafeAreaView, Share, Linking } from 'react-native';
...
export default function GroupInviteScreen() {
  ...
  const inviteCode = id.toUpperCase().slice(0, 6);
  const inviteLink = `https://popin.app/join/${id}`;
